...
class ManagingApp:
    ...
    def upload_vehicle(self, vehicle_type: str, brand: str, model: str, license_plate_number: str):
        ...
        self.vehicles.append(self.VALID_TYPES[vehicle_type](brand, model, license_plate_number))
    ...
    def repair_vehicles(self, count: int):
        vehicles = sorted([v for v in self.vehicles if v.is_damaged], key=lambda v: (v.brand, v.model))
